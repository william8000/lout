...
install: lout prg2lout
	...
	@echo ""
	@echo "(b) Installing library files into LOUTLIBDIR $(DESTDIR)$(LOUTLIBDIR)"
...
installdoc:
	@echo ""
	@echo "Creating LOUTDOCDIR $(DESTDIR)$(LOUTDOCDIR) and copying documentation into it"
...
installfr:
	@echo ""
	@echo "Putting French error messages into $(DESTDIR)$(LOUTLIBDIR)/$(LIBLOCA)/$(LOC_FR)"
...
installde:
	@echo ""
	@echo "Putting German error messages into $(DESTDIR)$(LOUTLIBDIR)/$(LIBLOCA)/$(LOC_DE)"
